...
//
//
//class evideo extends StatelessWidget {
//  @override
//  Widget build(BuildContext context) {
////    return Scaffold(
////      appBar: AppBar(
...
//
//    return MaterialApp(
//      title: 'สื่อการสอน VDO ระดับง่าย',
//      home: Scaffold(
//        appBar: AppBar(
//          title: Text('สื่อการสอนแบบ VDO "ระดับง่าย" '),
...
//                    MaterialPageRoute(builder: (context) => es1()));
//              },
//              color: Colors.green,
//              child: Text(
//                'ญาติ และ คำถาม',
...
//              onPressed: () {
//                Navigator.push(context,
//                    MaterialPageRoute(builder: (context) => es2()));
//              },
...
//              onPressed: () {
//                Navigator.push(context,
//                    MaterialPageRoute(builder: (context) => es3()));
//              },
//              color: Colors.red,
//              child: Text(
//                'วัน เดือน ปี',
...
//              onPressed: () {
//                Navigator.push(context,
//                    MaterialPageRoute(builder: (context) => es4()));
//              },
//              color: Colors.brown,
//              child: Text(
//                'สัตว์',
