...
class mvideo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
//    return Scaffold(
//      appBar: AppBar(
...
//}
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('สื่อการสอนแบบ VDO "ระดับปานกลาง" '),
        ...
        body: ListView(
          children: <Widget>[
            RaisedButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => me1()));
              },
              color: Colors.green,
              child: Text(
                'ร่างกาย',
            ...
            RaisedButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => me2()));
              },
            ...
            RaisedButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => me3()));
              },
              color: Colors.red,
              child: Text(
                'สถานที่',
